...
class RegressionModel(object):
    ...
    def predict_error(self,y_data,X_data):
        """
        ...
        if self.trained_model is not None:
            ...
            return self.param.ERROR_FUNC(y_data,y_pred)
        else:
...
class Polynomial(LeastSquares):
    ...
    def __init__(self, *args, **kwargs):
        LeastSquares.__init__(self, *args, **kwargs)
    
    def preprocessing(y_data,X_data):
...
class KNearestNeighbors(RegressionModel):
    ...
    def preprocessing(self,y_data,X_data):
